...
const Habilidades = () => {
    ...
    return (
        <section id="habilidades" className="bg-white pt-24 pb-32 px-40 flex flex-col gap-14 [@media(max-width:1180px)]:px-20 [@media(max-width:690px)]:px-10 [@media(max-width:550px)]:px-5! [@media(max-width:550px)]:pt-16 [@media(max-width:550px)]:pb-20">
        
            <div className="flex flex-col gap-4">
                <h2 className="text-4xl font-bold [@media(max-width:550px)]:text-2xl">Minhas Habilidades</h2>
                <p className="text-base text-[#6C757D] [@media(max-width:550px)]:text-sm">Tecnologias e ferramentas que utilizo para criar soluções eficientes</p>
            </div>
