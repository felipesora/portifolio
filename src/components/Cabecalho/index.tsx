...
const Cabecalho = ({ tipo = "home" }: CabecalhoProps) => {
    ...
    return (
        <header className="fixed top-0 left-0 w-full z-50 bg-(--color-primary) py-9 px-8 flex justify-between items-center border-b border-b-[#292929] [@media(max-width:1240px)]:px-4 [@media(max-width:1530px)]:py-5 [@media(max-width:490px)]:py-5">
