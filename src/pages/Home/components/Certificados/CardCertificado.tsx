...
const CardCertificado = ({ nome, instituicao, link }: CardCertificadoProps) => {
    return (
        <div className="bg-[#EBEBEB] shadow-sm rounded-[10px] py-16 px-24 flex flex-col gap-5 items-center border border-transparent hover:border-[#111111] hover:-translate-y-1 hover:shadow-md transition-all duration-300 ease-out [@media(max-width:1540px)]:w-[100%] [@media(max-width:1180px)]:py-12 [@media(max-width:1540px)]:px-16">
